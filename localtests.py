...
cubes = fio.read_model_run('waroona_run2', fdtime=[datetime(2016,1,5,15),datetime(2016,1,5,16)],
                           add_dewpoint=True, add_theta=True, add_RH=True, add_winds=True)
print(cubes)


def create_wind_profile_csv():
