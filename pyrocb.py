...
def examine_metrics(mr,hour=0,extent=None,levels=[0,5,10,20],HSkip=None):
    """
...
if __name__ == '__main__':
    ...
    examine_metrics('sirivan_run1',hour=0,HSkip=5)
    ...
    if False:
        ...
        for hi,hour in enumerate(sirivan_good_half):
            if True:
                examine_metrics('sirivan_run1',hour=hi+13,HSkip=5)
